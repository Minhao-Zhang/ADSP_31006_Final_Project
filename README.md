...
data/
  ...
  processed/    # merged_features_weekly.parquet (184 features, W-FRI frequency)
...
- **Target:** weekly commodity prices (`data/raw/cleaned_fruit_veg.csv`), 2015–2026. *Note: recent reporting shifted to Mondays; these are snapped forward to the W-FRI grid.*
- **Exogenous:** API agricultural indices, UK road fuel prices, ONS SPPI freight index
- **Processed:** `data/processed/merged_features_weekly.parquet` — lags, rolling stats, YoY deltas, cyclical calendar features, and shock indicators for the 2021Q4–2023Q1 energy crisis
